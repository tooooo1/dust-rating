...
city.map((i) => {
  let dustState = {
    ...
    grade:
      (parseInt(i.response.body.items[4].pm10Grade) +
        parseInt(i.response.body.items[4].pm25Grade)) /
      2,
    ultraDust: i.response.body.items[4].pm25Value,
    totalValue:
      (parseInt(i.response.body.items[4].pm10Value) +
        parseInt(i.response.body.items[4].pm25Value)) /
      2,
